...
st.title("Gemma3 text LLM app examples Unit11_1 | StudentID")
colors = ['red', 'blue', 'green', 'orange', 'purple']
user_input = st.text_input("You can ask any question:", "")

if st.button("send") or user_input:
    st.markdown(f"<span style='color:{random.choice(colors)};'>Please wait a moment, thinking… I’ll respond shortly...</span>",
