...
response = client.chat.completions.create(
        model="gpt-4.1-nano",
        messages=[
            {"role": "user", "content": "Please write a bedtime story, suitable for children, with a length of approximately 300 characters "},
        ],
        stream=True,
    )
...
print(" ")
print('16_4LLM04'+ ' | Student ID | ', datetime.datetime.now())